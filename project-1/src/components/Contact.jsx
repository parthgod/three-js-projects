...
const Contact = () => {
  ...
  return (
    <div className='xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden'>
      <motion.div variants={slideIn("left", "tween", 0.8, 1)} className='flex-[0.75] bg-black-100 p-8 rounded-2xl'>
      ...
      <motion.div variants={slideIn("right", "tween", 0.8, 1)} className='xl:flex-1 xl:h-auto md:h-[550px] h-[350px]'>
        <EarthCanvas />
      </motion.div>
    </div>
  )
